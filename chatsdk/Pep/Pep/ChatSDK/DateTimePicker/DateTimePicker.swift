...
open class DatePickerDialog: UIView {
    ...
    public init(textColor: UIColor = UIColor.black,
                buttonColor: UIColor = UIColor(red:0.33, green:0.44, blue:1.00, alpha:1.0),
    ...
    @objc func deviceOrientationDidChange(_ notification: Notification) {
        ...
        let dialogSize = CGSize(width: UIScreen.main.bounds.size.width * 0.95, height: 230 + kDefaultButtonHeight + kDefaultButtonSpacerHeight)
    ...
    private func createContainerView() -> UIView {
        ...
        let container = UIView(frame: CGRect(x: (screenSize.width - dialogSize.width) / 1.5,
        ...
        //Title
        self.titleLabel = UILabel(frame: CGRect(x: 0, y: 10, width: UIScreen.main.bounds.size.width * 0.95, height: 30))
    ...
    fileprivate func configuredDatePicker() -> UIDatePicker {
        ...
        datePicker.frame.size.width = UIScreen.main.bounds.size.width * 0.95
